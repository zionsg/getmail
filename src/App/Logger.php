...
class Logger extends AbstractLogger
{
    ...
    public function log($level, string|\Stringable $message, array $context = []): void
    {
        ...
        // Current request if any, and server info
        $request = $context['request'] ?? null;
        $requestId = '';
        $serverParams = $_SERVER;
        if ($request instanceof ServerRequestInterface) {
            $requestId = $request->getAttribute(Application::ATTR_REQUEST_ID);
        ...
        // Use [REQ null] if no request info available, e.g. if log is output by cron job or at application startup.
        // The request ID is a unique identifier generated by the application for each incoming request that can be
        // used in database audit records or application logs to determine the events/actions that happened
        ...
        //         [MSG <message>]
        //         [REQ <client IP/port> <method> <content type> <full url with querystring> "<useragent>" <request ID>]
        //         [SVR <server IP/port> <deployment environment> <Docker container name or hostname> <version>]
        $text = str_replace(["\n", "\r", "\t"], ' ', sprintf(
